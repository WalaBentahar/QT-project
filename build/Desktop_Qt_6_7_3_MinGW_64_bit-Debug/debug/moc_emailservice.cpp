/****************************************************************************
** Meta object code from reading C++ file 'emailservice.h'
**
...
#error "The header file 'emailservice.h' doesn't include <QObject>."
...
void EmailService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EmailService *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->emailSent((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->onEmailReplyFinished(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (EmailService::*)(bool , const QString & );
            if (_t _q_method = &EmailService::emailSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EmailService::emailSent(bool _t1, const QString & _t2)
{
